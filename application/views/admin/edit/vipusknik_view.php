<div id="content">
    ...
    <h2 id="content_name">Редагування групи випускників</h2>

    <form name="vipusknik" action="" method="post" enctype="multipart/form-data">
        <div id="form">
            ...
            <p>
                ...
                <img class="photo_upload" alt="<?=$pages_info['group'];?>" src="<?=base_url();?>images/vipusknik/<?=$pages_info['img'];?>">
