<div id="nav_column">
    <form id="login" class="side_block">
        <h2>АВТОРИЗАЦІЯ</h2>
        <fieldset id="inputs">
    ...
    <div id="links" class="side_block">
        <h2>ПОСИЛАННЯ</h2>
        <a target="_blank" href="http://www.mon.gov.ua/" title="Міністерство освіти і науки України"><img src="images/links/mon.jpg" /></a>
        <a target="_blank" href="http://www.guonkh.gov.ua/" title="Департамент науки і освіти Харківської обласної державної адміністрації"><img src="images/links/dnokh.jpg" alt="Департамент науки і освіти Харківської обласної державної адміністрації" /></a>
        <a target="_blank" href="http://www.vstup.info/" title="Інформаційна система «Конкурс»"><img src="images/links/vstup_info.jpg" alt="Інформаційна система «Конкурс»" /></a>
        <a target="_blank" href="http://pedpresa.com.ua"><img src="images/links/ped_presa.gif" title="Освітній портал - ПедПРЕСА" alt="Освітній портал ПедПреса" /></a>
        <a target="_blank" href="http://zno-kharkiv.org.ua" title="Харківський регіональний центр оцінювання якості освіти"><img src="images/links/khzno.jpg" /></a>
        <a target="_blank" href="http://www.dcz.gov.ua/kha/" title="Харківський регіональний центр зайнятості"><img src="images/links/khrcz.jpg" /></a>
        <a target="_blank" href="http://www.osvita.ua/" title="Освітa в Україні"><img src="images/links/osvita_ua.jpg" alt="Освітa в Україні" /></a>
        <a target="_blank" href="http://www.osvita.org.ua/" title="Освітній портал - все про освіту в Україні"><img src="images/links/osvitaPortal.jpg" alt="Освітній портал" /></a>
        <a target="_blank" href="http://www.khai.edu/" title="Національний аерокосмічний університет ім. М.Є.Жуковського"><img src="images/links/khai.jpg" /></a>
        <a target="_blank" href="http://www.nure.ua/" title="Харківський національний університет радіоелектроніки"><img src="images/links/knure.jpg" /></a>
        <a target="_blank" href="http://www.kpi.kharkov.ua/" title="Національний технічний університет «ХПІ»"><img src="images/links/khpi.jpg" /></a>
        <a target="_blank" href="http://www.univer.kharkov.ua/" title="Харківський національний університет імені В.Н.Каразіна"><img src="images/links/karazina.jpg" /></a>
    </div>
